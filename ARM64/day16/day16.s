...
L_tf_done:
    ...
    str XZR, [SP, #-16]!
    mov X1, SP // Arg 2: space on stack
    adrp X2, accumulate_handler@PAGE
    add X2, X2, accumulate_handler@PAGEOFF // Arg 3: handler
    bl _array1_enumerate

    ldr X0, [SP], #16 // Pop accumulated value.
